...
`;
	...
	return {
		...
		Response: _Response,
		Headers: _Headers,
		FormData: typeof FormData !== "undefined" ? FormData : class FormData$2 {
			constructor() {
				throw new Error(`file uploads aren't supported in this environment yet as 'FormData' is undefined. ${recommendation}`);
			}
		},
		Blob: typeof Blob !== "undefined" ? Blob : class Blob$2 {
			constructor() {
				throw new Error(`file uploads aren't supported in this environment yet as 'Blob' is undefined. ${recommendation}`);
			}
		},
		File: typeof File !== "undefined" ? File : class File$2 {
			constructor() {
				throw new Error(`file uploads aren't supported in this environment yet as 'File' is undefined. ${recommendation}`);
			}
		},
		ReadableStream: typeof ReadableStream !== "undefined" ? ReadableStream : class ReadableStream$2 {
			constructor() {
			...
			try {
				for await (const sse of iterMessages()) {
					...
					if (sse.event === null || sse.event === "error") {
						...
						if (data && data.error) throw new APIError(data.error.status_code, data.error, data.error.message, void 0);
						yield data;
					}
				}
				done = true;
...
//#endregion
//#region node_modules/groq-sdk/core.mjs
...
var APIClient = class {
	constructor({ baseURL, baseURLOverridden, maxRetries = 2, timeout = 6e4, httpAgent, fetch: overriddenFetch }) {
...
var AbstractPage = class {
	...
	async getNextPage() {
		...
		if (!nextInfo) throw new GroqError("No next page expected; please check `.hasNextPage()` before calling `.getNextPage()`.");
...
_a = Groq, _Groq_instances = /* @__PURE__ */ new WeakSet();
Groq.Groq = _a;
